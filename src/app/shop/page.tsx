...
async function getCategories(): Promise<WooCommerceCategory[]> {
  ...
  const res = await fetch('https://members.onetreefarm.org/wp-json/wc/v3/products/categories?per_page=100', {
    headers: {
      ...
      <div className="pt-16 px-4">
        ...
        <div className="flex mt-4 border-t border-b py-4">
          <div className="flex-1 border-r px-4 py-2">
            <p className="text-lg font-medium">Free Delivery on orders over &pound;100</p>
